...
//!   [`FileEntry::path`](naui_core::FileEntry::path) は常に `None` になる。
//!   代わりに [`FileEntry::source`](naui_core::FileEntry::source) が
...
use naui_core::{accept_attribute, FileEntry, FileFilter, FilePickerMode, Result};
